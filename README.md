...
- Privacy and support contact: `Juvenile454-timo@web.de`
- App source code, signing material and user data are **not** part of this repository.

The site is a self-contained static HTML document. It uses no first-party cookies, analytics, external fonts or external scripts.
